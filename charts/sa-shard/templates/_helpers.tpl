...
{{/*
get the configmgr service name
*/}}
{{- define "configmgrservicename" -}}
{{ template "fullname" (dict "Chart" (dict "Name" "configmgr") "Values" (index .Values "configmgr") "Release" .Release "Capabilities" .Capabilities) }}
{{- end -}}
